...
const isGirlsPage = pathname.startsWith("/squad-hub/girls");
  return (
    <motion.footer
      ...
      className={`relative z-10 w-full backdrop-blur-xl mobile-low-blur pt-12 pb-8 text-white transition-colors duration-300 ${
  isGirlsPage
    ? "bg-[#140814]/85 border-t border-pink-400/20"
    : "bg-black/80 border-t border-[#E9C349]/20"
}`}
      >
  ...
  className={`relative w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 ${
    isGirlsPage
      ? "border-pink-400/30 shadow-[0_0_20px_rgba(236,72,153,0.15)]"
      : "border-[#E9C349]/30 shadow-[0_0_20px_rgba(233,195,73,0.15)]"
  }`}
>
          ...
          <h3 className="font-extrabold italic text-2xl uppercase tracking-tighter text-white">
            Odyssey <span className={isGirlsPage ? "text-pink-400" : "text-[#E9C349]"}>FC</span>
          </h3>
        ...
        <div className="flex flex-col items-center md:items-start gap-3 w-full">
          ...
          <div className="flex flex-col gap-2.5 items-center md:items-start">
            <Link
              href="/squad-hub/boys"
              className={`text-gray-400 transition-colors text-sm font-medium uppercase tracking-wide ${
  isGirlsPage
    ? "hover:text-pink-400"
    : "hover:text-[#E9C349]"
}`}
        ...
        <div className="flex flex-col items-center md:items-start gap-5 w-full">
          ...
          <div className="flex flex-col gap-3 items-center md:items-start w-full">
            <a
              ...
              className={`flex items-center gap-3 text-sm font-medium group break-all transition-colors ${
  isGirlsPage
    ? "text-gray-400 hover:text-pink-300"
    : "text-gray-400 hover:text-[#E9C349]"
}`}
            >
              <Mail 
    ...
    : "text-[#E9C349]"
          ...
          <div className="flex gap-4 mt-1">
            ...
            <a
              ...
              aria-label="Facebook"
              className={`bg-white/5 p-2.5 rounded-full transition-all duration-300 text-gray-300 block ${
  isGirlsPage
    ? "hover:bg-pink-500/20 hover:text-pink-400"
    : "hover:bg-[#E9C349]/20 hover:text-[#E9C349]"
}`}
            >
  ...
  isGirlsPage
    ...
    : "hover:bg-[#E9C349]/20 hover:text-[#E9C349]"
     ...
     <div
  className={`w-full md:w-[80%] mx-auto px-6 border-t mt-10 pt-6 text-center flex flex-col md:flex-row justify-between items-center gap-4 ${
    isGirlsPage
      ? "border-pink-400/10"
      : "border-[#E9C349]/10"
  }`}
>
       <p className="text-gray-500 text-xs font-medium uppercase tracking-wider">
          ...
          <span
            className={isGirlsPage ? "text-pink-400 font-semibold" : "text-[#E9C349] font-semibold"}
            >
            Vertexora Solutions
          </span>
          .
