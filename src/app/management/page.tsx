...
const MANAGEMENT_MEMBERS = [
  {
    id: 1,
    name: "Fahmida Yasmin Biva",
    role: "Girls Team Manager",
    image: "/manager7.jpeg",
    bio: "Leading the women's squad with a strong focus on discipline, teamwork, and player development. She coordinates training activities, supports athlete growth, and ensures the team represents Odyssey FC with professionalism on and off the field.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    role: "Second Squad Manager",
    image: "/manager8.jpeg",
    bio: "Supporting first-team operations by coordinating training sessions, organizing player schedules, and maintaining seamless communication between coaching staff and players. His attention to detail ensures every squad activity runs efficiently.",
  },
  {
    id: 6,
